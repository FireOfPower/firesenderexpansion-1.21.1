...
public class EndLordArmorRenderer extends GeoArmorRenderer<EndLordArmorItem> {
    public EndLordArmorRenderer(EndLordArmor endLordArmorModel) {
        super(new EndLordArmor());
        this.addRenderLayer(new EndLordArmorLayer(this));
    ...
    public RenderType getRenderType(EndLordArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
