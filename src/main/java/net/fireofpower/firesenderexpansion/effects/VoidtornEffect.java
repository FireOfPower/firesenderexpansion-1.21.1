...
public class VoidtornEffect extends MagicMobEffect {
    public VoidtornEffect() {
        ...
        addAttributeModifier(AttributeRegistry.SPELL_POWER, ResourceLocation.fromNamespaceAndPath(FiresEnderExpansion.MODID,"voidtorn_armor"),-5,AttributeModifier.Operation.ADD_VALUE);
    }
}
