...
public class AscendedCasterEffect extends MobEffect {
    ...
    public AscendedCasterEffect() {
        ...
        addAttributeModifier(AttributeRegistry.MANA_REGEN, ResourceLocation.fromNamespaceAndPath(FiresEnderExpansion.MODID,"ascended_caster_mana_regen"), 0.25, AttributeModifier.Operation.ADD_MULTIPLIED_BASE);
        ...
        addAttributeModifier(AttributeRegistry.COOLDOWN_REDUCTION, ResourceLocation.fromNamespaceAndPath(FiresEnderExpansion.MODID,"ascended_caster_cooldown_reduction"),0.1,AttributeModifier.Operation.ADD_MULTIPLIED_BASE);
