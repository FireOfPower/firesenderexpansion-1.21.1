...
public class FEESpellAnimations {
    ...
    public static final AnimationHolder ANIMATION_HOLLOW_CRYSTAL_CAST = new AnimationHolder(FiresEnderExpansion.MODID + ":hollow_crystal_cast", true);
    ...
    public static final AnimationHolder ANIMATION_GATE_OF_ENDER_OPEN = new AnimationHolder(FiresEnderExpansion.MODID +":gate_of_end_open",true);
}
